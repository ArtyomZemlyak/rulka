...
exec gamemoderun wine ./TMLoader.exe run TmForever "Default" /configstring="set custom_port $1; toggle_console" #WINEFSYNC=1 STAGING_SHARED_MEMORY=1 STAGING_WRITECOPY=1